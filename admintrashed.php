        ...
        <div class="page-content" id="admin_content">
            ...
            <div class="container-fluid">
                <div class="card card-default mt-3" id="setting_container">
                    <h3 class="font-weight-bold pl-4 pt-4" id="setting_headings">Archives</h3>
                    <div class="card-body">
...
<div class="modal fade" id="restore_modal" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-info">Restore this row?</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <div class="modal-body">
                <p>Are you sure you want restore this row?</p>
                <form method="POST" action="includes/form_handlers/restore_records.php" id="form-restore-record">
                    <input type="hidden" name="records_id">
                </form>
            </div>

            <div class="modal-footer">
                <button type="submit" form="form-restore-record" class="btn btn-info">Restore</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        function load_data(page, query = '') {
            $.ajax({
                url: "includes/handlers/ajax_fetch_trashed_records.php",
                method: "POST",
                data: {
                    page: page,
                    query: query
